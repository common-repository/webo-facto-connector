...
= 1.40 =
Mise à jour utilisateur subscriber Sso  déjà connecté en administrateur
Validation de l'extension pour WordPress 6.6.2

= 1.39 =
Correction privilège subscriber en admin lors de l'authentification SSO

= 1.38 =
Avoir les bons privilèges admin lors de l'authentification SSO
